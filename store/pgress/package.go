...
func (store PgressStore) GetPackages() (*[]model.Package, error) {
	...
	if resp.Error != nil {
		util.Log(model.LogLevelError, model.PgressPackageLevel, model.GetPackages,
...
func (store PgressStore) GetPackage(pkgID string) (*model.Package, error) {
	...
	if resp.Error != nil {
		util.Log(model.LogLevelError, model.PgressPackageLevel, model.GetPackage,
...
func (store PgressStore) CreatePackage(pkg *model.Package) error {
	...
	if resp.Error != nil {
		util.Log(model.LogLevelError, model.PgressPackageLevel, model.CreatePackage,
